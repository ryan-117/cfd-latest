...
INSERT INTO `cms_category` VALUES
	 ...
	 (9, 0,'','','','关于我们','aboutus','/aboutus','','1','',0,'0','0','0','about-us.html','about-us.html','2025-09-13 20:57:21','2025-09-13 20:59:58');
...
INSERT INTO `sys_menu` VALUES (9, 8, '导航管理', 'category-index', 0, '/category', '@/views/cms/category/index.vue', '', NULL, 'api.category.list', 'C', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (10, 9, '导航新增', 'category-add', 0, '/category/add', '@/views/cms/category/add.vue', '', NULL, 'api:category:add', 'C', '2', '2', '2', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (11, 9, '导航修改', 'category-edit', 0, '/category/edit/:id', '@/views/cms/category/edit.vue', '', NULL, 'api:category.edit', 'C', '2', '2', '2', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (12, 9, '导航删除', '', 0, '', '', '', NULL, 'api:category:del', 'F', '2', '2', '2', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (13, 9, '导航查询', '', 0, '', '', '', NULL, 'api:category:query', 'F', '2', '2', '2', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (14, 8, '新闻管理', 'article-index', 0, '/article', '@/views/cms/article/index.vue', '', NULL, 'api:article:list', 'C', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (15, 14, '新闻新增', 'article-add', 0, '/article/add', '@/views/cms/article/add.vue', '', NULL, 'api:article.add', 'C', '2', '2', '2', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (16, 14, '新闻修改', 'article-edit', 0, '/article/edit/:id', '@/views/cms/article/edit.vue', '', NULL, 'api:article:edit', 'C', '2', '2', '2', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (17, 14, '新闻删除', '', 0, '', NULL, '', NULL, 'api:article:del', 'F', '2', '2', '2', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (18, 14, '新闻查询', '', 0, '', NULL, '', NULL, 'api:article:query', 'F', '2', '2', '2', NULL, '', NULL, '', NULL, '');

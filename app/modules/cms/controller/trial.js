...
import trial from "../service/trial.js";
...
let TrialController = {
  ...
  async delete(req, res, next) {
    try {
      const { id } = req.query;
      const data = await trial.delete(id);
      res.json({ ...success, data: data });
    } catch (err) {
      next(err);
    }
  ...
  async update(req, res, next) {
    try {
      ...
      const data = await trial.update(body);
      res.json({ ...success, data: data });
    } catch (err) {
      next(err);
    }
  ...
  async detail(req, res, next) {
    try {
      const { id } = req.query;
      const data = await trial.detail(id);
      res.json({ ...success, data: data });
    } catch (err) {
      next(err);
    }
  ...
  async findSubId(req, res, next) {
    try {
      const { id } = req.query;
      const data = await trial.findSubId(id);
      res.json({ ...success, data: data });
    } catch (err) {
      next(err);
    }
  ...
  async search(req, res, next) {
    try {
      ...
      const data = await trial.search(keyword, cur, pageSize, +cid);
  ...
  async list(req, res, next) {
    try {
      ...
      const data = await trial.list(cur, pageSize, cid);
      data.list.forEach((ele) => {
  ...
  async findField(req, res, next) {
    try {
      const { cid } = req.query;
      const data = await trial.findField(cid);
      res.json({ ...success, data: data });
    } catch (err) {
      next(err);
    }
